...
export default function AdminSessionsPanel({ sessions }) {
  return (
          ...
          <article key={session.id} className="admin-session-row">
            ...
            <div className="admin-session-footer">
              ...
              <div className="table-actions">
                <ActionButton tone="default" size="sm">Предупредить</ActionButton>
                <ActionButton tone="danger" size="sm">Завершить</ActionButton>
              </div>
            </div>
          </article>
        ))}
